               ...
               <div className="flex items-center">
                  ...
                  <div className="ml-4">
                     <div className="text-md font-medium text-gray-900">
                        {props.cobro.product_description}
                     </div>
                     <div className="text-sm text-indigo-800">
                        <a href={props.cobro.qr_url} target="_blank">Abrir QR</a>
                     </div>
                  </div>
               </div>
            </td>
            <td className="px-6 py-4 whitespace-nowrap">
               <div className="text-md text-gray-900 font-medium pb-2">${props.cobro.product_price}</div>
               <div className="text-xs text-gray-500 inline-flex items-center">{cryptoIcon(props.cobro.crypto_coin)}
                  <span className="pl-1">
                     {props.cobro.crypto_address}
                  </span>
               </div>
            </td>
            <td className="px-6 py-4 whitespace-nowrap">
