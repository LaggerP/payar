...
export default function Login () {
  ...
  const login = async (e) => {
    ...
    try {
      ...
      console.log(res)
      Cookie.set('_id', userId._id, { expires: hourExpiration })
      if (res.status !== 200) {
      ...
      setMessage('Fallo el inicio de sesión. Verifique sus credenciales')
    }
  }
      ...
      <>
         <div className="flex flex-row bg-gray-50 ">
            ...
            <div className="flex flex-col justify-center w-full h-screen md:w-2/5 px-10 md:px-24">
               <div>
                  <h2 className="mt-6 text-center text-2xl md:text-4xl font-extrabold text-gray-900">
               ...
               <form id="loginForm" className="mt-8 space-y-6" onSubmit={login} method="POST">
                  ...
                  <div className="text-center text-sm text-red-500 font-medium">
                     {
                        wrongCredentials ? <span>{message}</span> : null
                     }
                  </div>
                  <div>
