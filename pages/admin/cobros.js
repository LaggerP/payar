              ...
              <div className="shadow overflow-hidden sm:rounded-md">
                <div className="px-4 py-5 bg-white sm:p-6">
                  <div className="flex flex-col space-y-5">
                    <div className="">
                      <label htmlFor="product_description" className="block text-sm font-medium text-gray-700">Descripción del producto a vender</label>
                    ...
                    <div className="">
                      <label htmlFor="crypto_coin" className="block text-sm font-medium text-gray-700">Selecciones cripto a usar</label>
                    ...
                    <div className="">
                      <label htmlFor="crypto_address" className="block text-sm font-medium text-gray-700">Selecciones direccion de billetera (Wallet Address)</label>
                      <select id="crypto_address" name="crypto_address" className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"  required onChange={handleChange}>
                        <option selected="selected">Seleccione dirección asociada a la criptomoneda seleccionada</option>
                        {
                          data.map((address, idx) =>
                            <option key={idx}>{address.crypto_address} (Ref: {address.crypto_reference})</option>
                          )
                        }
                      </select>
                    </div>
                    <div className="col-span-6">
                      <label htmlFor="product_price" className="block text-sm font-medium text-gray-700">Monto en pesos (ARS)</label>
                      <input type="number" min="1" step="any" name="product_price" id="product_price" autoComplete="none" className="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border border-gray-300 rounded-md" placeholder="Ingrese el monto en pesos" required onChange={handleChange}/>
                    </div>
